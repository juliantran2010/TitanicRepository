...
+ [10 April 1912 - 12:00 p.m. (Titanic leaves Southampton)]
...
+ [14 April 1912 - 9:30 p.m.]
    ...
    Companion: Perfect timing! That gives you about two hours before the collision to investigate, find the lookout keys, and warn the bridge!
    -> step_3_confirmation

+ [14 April 1912 - 11:45 p.m. (Just before the collision)]
    Companion: Too late! The lookout strikes the bell at 11:40 p.m., and the ship hits the ice moments later!
    Companion: If you arrive at 11:45 p.m., the hull is already ripped open. We need you there EARLIER.
    -> step_2_time

+ [15 April 1912 - 2:20 a.m. (Titanic sinks)]
...
// ==========================================
=== step_3_confirmation ===
Companion: All parameters entered:
Companion: <color=\#5CF59B>Destination:</color> RMS Titanic
Companion: <color=\#5CF59B>Location:</color> {chosen_location}
Companion: <color=\#5CF59B>Arrival Time:</color> {chosen_time}
Companion: Are you ready to activate the time machine?

+ [ACTIVATE TIME MACHINE]
    Companion: Initiating quantum sequence... Hold on!
